...
ВЕРСИИ ЗАВИСИМОСТЕЙ ДЛЯ TERMUX
==============================
- Vite: максимальная рабочая версия 4.5.14
- Версии 5.x+, 6.x+, 7.x+ НЕ работают в Termux из-за проблем с native модулями Rollup
- Используется override: "@rollup/rollup-android-arm64": "npm:@rollup/rollup-wasm-node@*"
